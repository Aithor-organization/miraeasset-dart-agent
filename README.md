...
**응답** — 주최측 명시 4필드를 **항상** 포함하고, 부가 필드로 확장한다.
...
| 3 | 질의는 **통용명**("현대차"), 조인 키는 **법인명**("현대자동차") | 별칭 4-way + 수기 16종 |
...
| 테스트 | **232/232 통과** (`python3 -m pytest`, 전체 색인 기준) |
...
| API 계약 | 실 HTTP 10문항 전수 200 · 4필드 · abstention 7종 정상 |
